<?php
/** This controller is used for Opencart 2.3.0.0+ **/
...
class ControllerExtensionModuleMyParcel extends Controller {
    ...
    public function index() {
        ...
        $this->document->setTitle($this->language->get('heading_title') . 'for Opencart version 2.3 or higher');
        ...
        $data['action'] = $this->url->link('extension/module/myparcel', 'token=' . $this->session->data['token'], 'SSL');
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/myparcel')) {
