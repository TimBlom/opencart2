...
function createNewConsignment(orderId, retour)
{
    ...
    popup = window.open(
        'model/myparcel/myparcel_plugin.php?action=post' + '&order_id=' + orderId + '&timestamp=' + timestamp + retourparam,
        'myparcel',
...
function printConsignments(consignmentList)
{
    ...
    popup = window.open(
        'model/myparcel/myparcel_plugin.php?action=print' + '&consignments=' + consignmentList + '&timestamp=' + timestamp,
        'myparcel',
...
function processConsignments(consignmentList)
{
    ...
    popup = window.open(
        'model/myparcel/myparcel_plugin.php?action=process' + '&order_ids=' + consignmentList + '&timestamp=' + timestamp,
        'myparcel',
        'width=415,height=365,dependent,resizable,scrollbars'
        );
    if (window.focus) { popup.focus(); }
